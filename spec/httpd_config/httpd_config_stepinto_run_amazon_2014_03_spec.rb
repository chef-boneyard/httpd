...
describe 'httpd_config::default on amazon-2014.04' do
  ...
  context 'compiling the recipe' do
    ...
    it 'creates httpd_config[hello_again]' do
      expect(httpd_config_stepinto_run_amazon_2014_03).to create_httpd_config('hello_again')
    end
  end

  context 'stepping into httdd_config' do
    it 'creates directory[hello create /etc/httpd/conf.d]' do
      expect(httpd_config_stepinto_run_amazon_2014_03).to create_directory('hello create /etc/httpd/conf.d').with(
    ...
    it 'creates template[hello create /etc/httpd/conf.d/hello.conf]' do
      expect(httpd_config_stepinto_run_amazon_2014_03).to create_template('hello create /etc/httpd/conf.d/hello.conf').with(
    ...
    it 'creates directory[hello_again create /etc/httpd-foo/conf.d]' do
      expect(httpd_config_stepinto_run_amazon_2014_03).to create_directory('hello_again create /etc/httpd-foo/conf.d').with(
    ...
    it 'creates template[hello_again create /etc/httpd-foo/conf.d/hello_again.conf]' do
      expect(httpd_config_stepinto_run_amazon_2014_03).to create_template('hello_again create /etc/httpd-foo/conf.d/hello_again.conf').with(
