...
describe 'httpd_service::single on fedora-21' do
  let(:httpd_service_single_24_run_fedora_21) do
    ChefSpec::Runner.new(
      platform: 'fedora',
      version: '21'
  ...
  context 'when using default parameters' do
    it 'creates httpd_service[default]' do
      expect(httpd_service_single_24_run_fedora_21).to create_httpd_service('default')
        .with(
