...
describe 'httpd_service::multi on rhel-6.4' do
  ...
  context 'when stepping into httpd_service' do
    ...
    it 'creates template[instance-1 create /etc/httpd-instance-1/conf/magic]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-1 create /etc/httpd-instance-1/conf/magic').with(
    ...
    it 'creates template[instance-2 create /etc/httpd-instance-2/conf/magic]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-2 create /etc/httpd-instance-2/conf/magic').with(
