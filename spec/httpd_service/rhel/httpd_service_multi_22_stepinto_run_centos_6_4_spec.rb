...
describe 'httpd_service::multi on rhel-6.4' do
  ...
  context 'when compiling the test recipe' do
    ...
    it 'creates httpd_service[instance-1]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_httpd_service('instance-1').with(
    ...
    it 'creates httpd_service[instance-1]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_httpd_service('instance-2').with(
  ...
  context 'when stepping into httpd_service' do
    ...
    it 'manages service[default create httpd]' do
      ...
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to disable_service('default create httpd').with(
        :provider => Chef::Provider::Service::Init::Redhat
        )
    end

    it 'deletes link[default delete /usr/sbin/httpd]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to_not delete_link('default delete /usr/sbin/httpd').with(
    ...
    it 'deletes link[default delete /usr/sbin/httpd.worker]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to_not delete_link('default delete /usr/sbin/httpd.worker').with(
    ...
    it 'deletes link[default delete /usr/sbin/httpd.event]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to_not delete_link('default delete /usr/sbin/httpd.event').with(
    ...
    it 'deletes directory[default delete /etc/httpd]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to delete_directory('default delete /etc/httpd').with(
        :path => '/etc/httpd'
        )
    end

    it 'deletes directory[default delete /var/log/httpd]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to delete_directory('default delete /var/log/httpd').with(
        :path => '/var/log/httpd'
        )
    end

    it 'default delete /var/run/httpd' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to delete_directory('default delete /var/run/httpd').with(
        :path => '/var/run/httpd'
        )
    end

    it 'deletes link[default delete /etc/httpd/run]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to delete_link('default delete /etc/httpd/run').with(
    ...
    it 'installs httpd_module[instance-1 create log_config]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_httpd_module('instance-1 create log_config').with(
    ...
    it 'installs httpd_module[instance-1 create logio]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_httpd_module('instance-1 create logio').with(
        :module_name => 'logio',
        :httpd_version => '2.2',
        :instance => 'instance-1'
        )
    ...
    it 'creates link[instance-1 create /usr/sbin/httpd-instance-1]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-1 create /usr/sbin/httpd-instance-1').with(
    ...
    it 'creates link[instance-1 create /usr/sbin/httpd-instance-1.worker]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-1 create /usr/sbin/httpd-instance-1.worker').with(
    ...
    it 'creates link[instance-1 create /usr/sbin/httpd-instance-1.event]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-1 create /usr/sbin/httpd-instance-1.event').with(
    ...
    it 'creates httpd_config[instance-1 create mpm_prefork]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_httpd_config('instance-1 create mpm_prefork').with(
    ...
    it 'creates directory[instance-1 create /etc/httpd-instance-1]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-1 create /etc/httpd-instance-1').with(
    ...
    it 'creates directory[instance-1 create /etc/httpd-instance-1/conf]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-1 create /etc/httpd-instance-1/conf').with(
    ...
    it 'creates directory[instance-1 create /etc/httpd-instance-1/conf.d]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-1 create /etc/httpd-instance-1/conf.d').with(
    ...
    it 'creates directory[instance-1 create /usr/lib64/httpd/modules]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-1 create /usr/lib64/httpd/modules').with(
    ...
    it 'creates directory[instance-1 create /var/log/httpd-instance-1]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-1 create /var/log/httpd-instance-1').with(
    ...
    it 'creates link[instance-1 create /etc/httpd-instance-1/logs]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-1 create /etc/httpd-instance-1/logs').with(
    ...
    it 'creates link[instance-1 create /etc/httpd-instance-1/modules]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-1 create /etc/httpd-instance-1/modules').with(
    ...
    it 'creates link[instance-1 create /etc/httpd-instance-1/run]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-1 create /etc/httpd-instance-1/run').with(
    ...
    it 'creates directory[instance-1 create /var/run/httpd-instance-1]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-1 create /var/run/httpd-instance-1').with(
    ...
    it 'creates template[instance-1 create /etc/httpd-instance-1/conf/mime.types]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-1 create /etc/httpd-instance-1/conf/mime.types').with(
    ...
    it 'creates template[instance-1 create /etc/httpd-instance-1/conf/httpd.conf]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-1 create /etc/httpd-instance-1/conf/httpd.conf').with(
    ...
    it 'creates template[instance-1 create /etc/init.d/httpd-instance-1]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-1 create /etc/init.d/httpd-instance-1').with(
    ...
    it 'creates template[instance-1 create /etc/sysconfig/httpd-instance-1]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-1 create /etc/sysconfig/httpd-instance-1').with(
    ...
    it 'manages instance-1 create httpd-instance-1' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to start_service('instance-1 create httpd-instance-1').with(
        :service_name => 'httpd-instance-1',
        :provider => Chef::Provider::Service::Init::Redhat
        )
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to enable_service('instance-1 create httpd-instance-1').with(
        :service_name => 'httpd-instance-1',
        :provider => Chef::Provider::Service::Init::Redhat
        )
    end
    ...
    it 'installs package[instance-2 create net-tools]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to install_package('instance-2 create net-tools').with(
        :package_name => 'net-tools'
        )
    end

    it 'installs httpd_module[instance-2 create log_config]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_httpd_module('instance-2 create log_config').with(
        :module_name => 'log_config',
        :httpd_version => '2.2',
        :instance => 'instance-2'
        )
    ...
    it 'installs httpd_module[instance-2 create logio]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_httpd_module('instance-2 create logio').with(
        :module_name => 'logio',
        :httpd_version => '2.2',
        :instance => 'instance-2'
        )
    ...
    it 'creates link[instance-2 create /usr/sbin/httpd-instance-2]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-2 create /usr/sbin/httpd-instance-2').with(
    ...
    it 'creates link[instance-2 create /usr/sbin/httpd-instance-2.worker]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-2 create /usr/sbin/httpd-instance-2.worker').with(
    ...
    it 'creates link[instance-2 create /usr/sbin/httpd-instance-2.event]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-2 create /usr/sbin/httpd-instance-2.event').with(
    ...
    it 'creates httpd_config[instance-2 create mpm_prefork]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_httpd_config('instance-2 create mpm_prefork').with(
        :config_name => 'mpm_prefork',
        :instance => 'instance-2',
        :source => 'mpm.conf.erb',
        :cookbook => 'httpd'
    ...
    it 'creates directory[instance-2 create /etc/httpd-instance-2]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-2 create /etc/httpd-instance-2').with(
    ...
    it 'creates directory[instance-2 create /etc/httpd-instance-2/conf]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-2 create /etc/httpd-instance-2/conf').with(
    ...
    it 'creates directory[instance-2 create /etc/httpd-instance-2/conf.d]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-2 create /etc/httpd-instance-2/conf.d').with(
    ...
    it 'creates directory[instance-2 create /usr/lib64/httpd/modules]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-2 create /usr/lib64/httpd/modules').with(
        :path => '/usr/lib64/httpd/modules',
        :user => 'root',
        :group => 'root',
        :mode => '0755',
    ...
    it 'creates directory[instance-2 create /var/log/httpd-instance-2]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-2 create /var/log/httpd-instance-2').with(
    ...
    it 'creates link[instance-2 create /etc/httpd-instance-2/logs]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-2 create /etc/httpd-instance-2/logs').with(
    ...
    it 'creates link[instance-2 create /etc/httpd-instance-2/modules]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-2 create /etc/httpd-instance-2/modules').with(
    ...
    it 'creates link[instance-2 create /etc/httpd-instance-2/run]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_link('instance-2 create /etc/httpd-instance-2/run').with(
    ...
    it 'creates directory[instance-2 create /var/run/httpd-instance-2]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_directory('instance-2 create /var/run/httpd-instance-2').with(
    ...
    it 'creates template[instance-2 create /etc/httpd-instance-2/conf/mime.types]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-2 create /etc/httpd-instance-2/conf/mime.types').with(
    ...
    it 'creates template[instance-2 create /etc/httpd-instance-2/conf/httpd.conf]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-2 create /etc/httpd-instance-2/conf/httpd.conf').with(
    ...
    it 'creates template[instance-2 create /etc/init.d/httpd-instance-2]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-2 create /etc/init.d/httpd-instance-2').with(
    ...
    it 'creates template[instance-2 create /etc/sysconfig/httpd-instance-2]' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to create_template('instance-2 create /etc/sysconfig/httpd-instance-2').with(
    ...
    it 'manages instance-2 create httpd-instance-2' do
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to start_service('instance-2 create httpd-instance-2').with(
        :service_name => 'httpd-instance-2',
        :provider => Chef::Provider::Service::Init::Redhat
        )
      expect(httpd_service_multi_22_stepinto_run_centos_6_4).to enable_service('instance-2 create httpd-instance-2').with(
        :service_name => 'httpd-instance-2',
        :provider => Chef::Provider::Service::Init::Redhat
        )
    end
