...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_directory('default delete /var/run/apache2').with(
#         :recursive => true
#         )
#     end

#     it 'deletes directory[default delete /etc/apache2/conf.d]' do
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_directory('default delete /etc/apache2/conf.d').with(
#         :recursive => true
#         )
#     end
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_file('default delete /etc/apache2/magic')
#     end
...
#       expect(ubuntu_14_04_multi_stepinto_run).to create_directory('instance-1 create /var/run/apache2-instance-1').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to create_directory('instance-1 create /etc/apache2-instance-1/conf.d').with(
...
#         :source => '2.4/sysvinit/ubuntu-7/apache2.erb',
#         :owner => 'root',
#         :group => 'root',
#         :mode => '0755',
#         :cookbook => 'httpd'
...
#       expect(ubuntu_14_04_multi_stepinto_run).to create_link('instance-1 create /etc/apache2-instance-1/mods-enabled/mpm_prefork.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_file('instance-1 create /etc/apache2-instance-1/mods-available/mpm_worker.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_link('instance-1 create /etc/apache2-instance-1/mods-enabled/mpm_worker.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_file('instance-1 create /etc/apache2-instance-1/mods-available/mpm_event.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_link('instance-1 create /etc/apache2-instance-1/mods-enabled/mpm_event.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to create_directory('instance-2 create /var/run/apache2-instance-2').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to create_directory('instance-2 create /etc/apache2-instance-2/conf.d').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to create_template('instance-2 create /etc/apache2-instance-2/mods-available/mpm_prefork.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to create_link('instance-2 create /etc/apache2-instance-2/mods-enabled/mpm_prefork.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_file('instance-2 create /etc/apache2-instance-2/mods-available/mpm_worker.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_link('instance-2 create /etc/apache2-instance-2/mods-enabled/mpm_worker.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_file('instance-2 create /etc/apache2-instance-2/mods-available/mpm_event.conf').with(
...
#       expect(ubuntu_14_04_multi_stepinto_run).to delete_link('instance-2 create /etc/apache2-instance-2/mods-enabled/mpm_event.conf').with(
