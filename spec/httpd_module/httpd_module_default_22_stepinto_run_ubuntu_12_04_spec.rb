...
describe 'httpd_module::default on ubuntu-12.04' do
  ...
  context 'when using default parameters' do
    ...
    it 'installs package[auth_basic create apache2]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to install_package('auth_basic create apache2')
        .with(
    ...
    it 'creates directory[auth_basic create /etc/apache2/mods-available]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to create_directory('auth_basic create /etc/apache2/mods-available')
        .with(
    ...
    it 'creates template[auth_basic create /etc/apache2/mods-available/auth_basic.load]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to create_template('auth_basic create /etc/apache2/mods-available/auth_basic.load')
        .with(
    ...
    it 'renders file[auth_basic create /etc/apache2/mods-available/auth_basic.load]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to render_file('auth_basic create /etc/apache2/mods-available/auth_basic.load')
        .with_content(auth_basic_load_content)
    end

    it 'creates directory[auth_basic create /etc/apache2/mods-enabled]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to create_directory('auth_basic create /etc/apache2/mods-enabled')
        .with(
    ...
    it 'creates link[auth_basic create /etc/apache2/mods-enabled]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to create_link('auth_basic create /etc/apache2/mods-enabled/auth_basic.load')
        .with(
    ...
    it 'installs package[auth_kerb create libapache2-mod-auth-kerb]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to install_package('auth_kerb create libapache2-mod-auth-kerb')
        .with(
    ...
    it 'creates directory[auth_kerb create /etc/apache2/mods-available]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to create_directory('auth_kerb create /etc/apache2/mods-available')
        .with(
        path: '/etc/apache2/mods-available',
        owner: 'root',
        group: 'root',
    ...
    it 'creates template[auth_kerb create /etc/apache2/mods-available/auth_kerb.load]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to create_template('auth_kerb create /etc/apache2/mods-available/auth_kerb.load')
        .with(
    ...
    it 'creates directory[auth_kerb create /etc/apache2/mods-enabled]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to create_directory('auth_kerb create /etc/apache2/mods-enabled')
        .with(
        path: '/etc/apache2/mods-enabled',
        owner: 'root',
        group: 'root',
    ...
    it 'creates link[auth_kerb create /etc/apache2/mods-enabled]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to create_link('auth_kerb create /etc/apache2/mods-enabled/auth_kerb.load')
        .with(
    ...
    it 'renders file[auth_kerb create /etc/apache2/mods-available/auth_kerb.load]' do
      expect(httpd_module_default_22_stepinto_run_ubuntu_12_04).to render_file('auth_kerb create /etc/apache2/mods-available/auth_kerb.load')
