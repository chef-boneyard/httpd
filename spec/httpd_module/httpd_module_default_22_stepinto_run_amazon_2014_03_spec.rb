...
describe 'httpd_module::default on amazon-2014.04' do
  ...
  context 'when using default parameters' do
    ...
    it 'deletes file[auth_basic create /etc/httpd/conf.d/README]' do
      expect(httpd_module_default_22_stepinto_run_amazon_2014_03).to_not delete_file('auth_basic create /etc/httpd/conf.d/README').with(
        :path => '/etc/httpd/conf.d/README'
        )
    end

    it 'deletes file[auth_basic create httpd]' do
      expect(httpd_module_default_22_stepinto_run_amazon_2014_03).to_not delete_file('auth_basic create /etc/httpd/conf.d/welcome.conf').with(
        :path => '/etc/httpd/conf.d/welcome.conf'
        )
    end

    it 'deletes file[auth_basic create httpd]' do
      expect(httpd_module_default_22_stepinto_run_amazon_2014_03).to_not delete_file('auth_basic create /etc/httpd/conf.d/proxy_ajp.conf').with(
    ...
    it 'renders file[auth_basic create /etc/httpd/conf.d/auth_basic.load]' do
      expect(httpd_module_default_22_stepinto_run_amazon_2014_03).to render_file('auth_basic create /etc/httpd/conf.d/auth_basic.load').with_content(
    ...
    it 'renders file[auth_kerb create /etc/httpd/conf.d/auth_kerb.load]' do
      expect(httpd_module_default_22_stepinto_run_amazon_2014_03).to render_file('auth_kerb create /etc/httpd/conf.d/auth_kerb.load').with_content(
