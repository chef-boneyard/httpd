...
describe 'crossplat_test::thing on ubuntu-12_04' do
  ...
  context 'when using default parameters' do
    ...
    it 'steps into crossplat_thing and writes log[message for ubuntu-12.04]' do
      expect(ubuntu_12_04_default_stepinto_run).to write_log('Sorry, crossplat_thing support for ubuntu-12.04 has not yet been implemented.')
    end
  end
end
