...
describe 'httpd_test_default::server 2.2 on debian-7.2' do
  ...
  it 'steps into httpd_service[default] and installs package[default create apache2]' do
    expect(debian_7_2_default_stepinto_run).to install_package('default create apache2').with(
      :package_name => 'apache2'
      )
  end

  it 'steps into httpd_service[default] and does not run bash[default create remove_package_config]' do
    expect(debian_7_2_default_stepinto_run).to_not run_bash('default create remove_package_config').with(
      :user => 'root'
      )
  end

  it 'steps into httpd_service[default] and creates directory[default create /var/cache/apache2]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /var/cache/apache2').with(
  ...
  it 'steps into httpd_service[default] and creates directory[default create /var/log/apache2]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /var/log/apache2').with(
  ...
  it 'steps into httpd_service[default] and creates directory[default create /var/run/apache2]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /var/run/apache2').with(
  ...
  it 'steps into httpd_service[default] and creates directory[default create /etc/apache2]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /etc/apache2').with(
      :path => '/etc/apache2',
      :owner => 'root',
      :group => 'root',
      :mode => '0755'
  ...
  it 'steps into httpd_service[default] and creates directory[default create /etc/apache2/conf.d]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /etc/apache2/conf.d').with(
  ...
  it 'steps into httpd_service[default] and creates directory[default create /etc/apache2/mods-available]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /etc/apache2/mods-available').with(
  ...
  it 'steps into httpd_service[default] and creates directory[default create /etc/apache2/mods-enabled]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /etc/apache2/mods-enabled').with(
  ...
  it 'steps into httpd_service[default] and creates directory[default create /etc/apache2/sites-available]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /etc/apache2/sites-available').with(
  ...
  it 'steps into httpd_service[default] and creates directory[default create /etc/apache2/sites-enabled]' do
    expect(debian_7_2_default_stepinto_run).to create_directory('default create /etc/apache2/sites-enabled').with(
  ...
  it 'steps into httpd_service[default] and creates template[default create /usr/sbin/a2enmod]' do
    expect(debian_7_2_default_stepinto_run).to create_template('default create /usr/sbin/a2enmod').with(
  ...
  it 'steps into httpd_service[default] and creates link[default create /usr/sbin/a2enmod]' do
    expect(debian_7_2_default_stepinto_run).to_not create_link('default create /usr/sbin/a2enmod').with(
  ...
  it 'steps into httpd_service[default] and creates link[default create /usr/sbin/a2dismod]' do
    expect(debian_7_2_default_stepinto_run).to create_link('default create /usr/sbin/a2dismod').with(
  ...
  it 'steps into httpd_service[default] and creates link[default create /usr/sbin/a2ensite]' do
    expect(debian_7_2_default_stepinto_run).to create_link('default create /usr/sbin/a2ensite').with(
  ...
  it 'steps into httpd_service[default] and creates link[default create /usr/sbin/a2dissite]' do
    expect(debian_7_2_default_stepinto_run).to create_link('default create /usr/sbin/a2dissite').with(
  ...
  it 'steps into httpd_service[default] and delete file[default create /etc/apache2/ports.conf]' do
    expect(debian_7_2_default_stepinto_run).to delete_file('default create /etc/apache2/ports.conf').with(
      :path => '/etc/apache2/ports.conf'
      )
  end

  it 'steps into httpd_service[default] and creates template[default create /etc/init.d/apache2]' do
    expect(debian_7_2_default_stepinto_run).to create_template('default create /etc/init.d/apache2').with(
  ...
  it 'steps into httpd_service[default] and manages service[default create apache2]' do
    expect(debian_7_2_default_stepinto_run).to start_service('default create apache2')
    expect(debian_7_2_default_stepinto_run).to enable_service('default create apache2')
  end
end
