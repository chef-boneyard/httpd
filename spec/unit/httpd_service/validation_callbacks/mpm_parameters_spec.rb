...
describe 'httpd_test_broken::server 2.2 on debian-7.2 with invalid parameter' do
...
describe 'httpd_test_broken::server 2.2 on debian-7.2 with valid parameter' do
...
describe 'httpd_test_broken::server 2.4 on ubuntu 14.04 with invalid parameter' do
...
describe 'httpd_test_broken::server 2.4 on ubuntu 14.04 with valid parameter' do
