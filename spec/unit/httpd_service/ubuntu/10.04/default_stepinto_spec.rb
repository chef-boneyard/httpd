...
describe 'httpd_test_default::server on ubuntu-10.04' do
  let(:ubuntu_10_04_default_stepinto_run) do
    ChefSpec::Runner.new(
      ...
      node.set['httpd']['service_name'] = 'ubuntu_10_04_default_stepinto'
    end.converge('httpd_test_default::server')
  end

  context 'when using default parameters' do
    it 'creates httpd_service[ubuntu_10_04_default]' do
      expect(ubuntu_10_04_default_stepinto_run).to create_httpd_service('ubuntu_10_04_default_stepinto').with(
        :version => '2.2',
